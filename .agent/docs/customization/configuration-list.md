...
| `AGENT_DISPLAY_MODEL` | Optional `true` / `false` toggle for appending run metadata such as provider, model, and reasoning effort to Sepo comments. Defaults to `false`. |
