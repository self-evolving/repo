...
- `/add-rubrics` and `agent/add-rubrics` requests dispatch the rubrics add workflow, which keeps runtime code on the default branch and opens a proposal PR targeting `agent/rubrics`.
