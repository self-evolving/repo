...
| `agent-add-rubrics.yml` | `Agent / Rubrics / Add` | explicit `/add-rubrics`, triaged rubric requests, `agent/add-rubrics`, `workflow_dispatch` | Proposes add-or-update rubric YAML edits in a draft PR targeting `agent/rubrics` | Auto |
