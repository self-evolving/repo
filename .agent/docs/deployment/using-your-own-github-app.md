...
- **Actions**: read and write if you use approval dispatch, review artifacts, `/setup apply` repository variable updates, or related workflow-driven follow-up flows
