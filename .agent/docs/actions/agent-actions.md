...
| Install | `install` | `.github/prompts/agent-install.md` | first-class `/install` route or install request issue template for authorization; runs the dedicated install prompt with the install-only token |
