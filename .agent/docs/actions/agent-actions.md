...
| Skill | `skill` | `<skill_root>/<name>/SKILL.md` | inline skill route through `agent-router.yml`; optional `<skill_root>/<name>/setup.sh` hook; `/install owner/repo` aliases to the bundled `install-agent` skill |
