...
| Self merge | `agent-self-merge` | deterministic CLI | opt-in PR merge gate in `agent-self-merge.yml`; deterministic code merges or enables auto-merge only after current-head self-approval and merge checks pass |
