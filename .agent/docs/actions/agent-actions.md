...
| Self approve | `agent-self-approve` | `.github/prompts/agent-self-approve.md` | manual opt-in PR approval gate in `agent-self-approve.yml`; deterministic code submits approval only after current-head checks pass |
