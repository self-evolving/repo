...
traceability and for route-specific guards such as self-approval's
requester-author check, but they do not need to thread requester association and
route policy through every downstream workflow.
