...
boundary: direct `source_action=orchestrate` starts derive requester identity
...
inputs. Other downstream workflows do not need requester association and route
policy threaded through every handoff.
