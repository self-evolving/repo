...
| Add rubrics | Convert a preference request into a proposal PR targeting `agent/rubrics`; explicit direct wording commits straight to the branch. | `@sepo-agent /add-rubrics ...` |
