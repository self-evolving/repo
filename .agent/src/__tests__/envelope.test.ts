...
test("execution workflows expose automation handoff inputs", () => {
  ...
  assert.match(orchestrateHandoffCli, /PARENT_ORCHESTRATOR_LANE/);
  assert.match(orchestrateHandoffCli, /Child orchestrator lane/);
  ...
  assert.match(orchestrateHandoffCli, /orchestrator_context:\s*decision\.handoffContext \|\| orchestratorContext/);
  ...
  assert.match(implementWorkflow, /orchestrator_context:/);
  assert.match(implementWorkflow, /ORCHESTRATOR_CONTEXT:\s*\$\{\{ inputs\.orchestrator_context \}\}/);
  assert.match(reviewWorkflow, /orchestrator_context:/);
  assert.match(reviewWorkflow, /ORCHESTRATOR_CONTEXT:\s*\$\{\{ inputs\.orchestrator_context \}\}/);
  assert.match(fixPrPrompt, /\$\{ORCHESTRATOR_CONTEXT\}/);
  assert.match(implementPrompt, /\$\{ORCHESTRATOR_CONTEXT\}/);
  assert.match(reviewPrompt, /\$\{ORCHESTRATOR_CONTEXT\}/);
  ...
  assert.match(runSource, /"ORCHESTRATOR_LANE"/);
  assert.match(runSource, /"ORCHESTRATOR_PARENT_LANE"/);
  assert.match(runSource, /"ORCHESTRATION_CHAIN_ID"/);
