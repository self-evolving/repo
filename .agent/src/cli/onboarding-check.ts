...
//      ANTHROPIC_API_KEY_CONFIGURED, PI_AUTH_JSON_B64_CONFIGURED,
...
const issueNumber = runOnboardingCheck({
  ...
  piAuthJsonB64Configured: isTrue("PI_AUTH_JSON_B64_CONFIGURED"),
  piAuthJsonConfigured: isTrue("PI_AUTH_JSON_CONFIGURED"),
